...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ergodox(
        // Left hand
        BP_DLR, TD(TD_QUOTF1), BP_LDAQ, BP_RDAQ, BP_LPRN, BP_RPRN, KC_DEL,
        ...
        KC_CAPSLOCK, BP_DCIR, BP_V, BP_D, BP_L, BP_J, TD(TD_ZF12),
    ...
    [FNSPACE] = LAYOUT_ergodox(
        ...
        KC_CAPSLOCK, CAS, LGUI(KC_LEFT), LCTL(LSFT(KC_TAB)), LCTL(KC_TAB), LALT(KC_RIGHT), KC_RIGHT,
